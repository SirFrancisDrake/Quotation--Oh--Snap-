...
#define VERSION_HDBC "2.2.6.1"
#define MIN_VERSION_HDBC(major1,major2,minor) (\
  (major1) <  2 || \
  (major1) == 2 && (major2) <  2 || \
  (major1) == 2 && (major2) == 2 && (minor) <= 6)

/* package HDBC-postgresql-2.2.3.1 */
#define VERSION_HDBC_postgresql "2.2.3.1"
...
/* package heist-0.7.0.1 */
#define VERSION_heist "0.7.0.1"
...
/* package snap-server-0.7 */
#define VERSION_snap_server "0.7"
